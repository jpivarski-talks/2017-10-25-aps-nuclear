...
%% \vspace{-5.2 cm}
%% \begin{center}
%% \fcolorbox{violet}{white}{\begin{minipage}{\linewidth}
%% \vspace{0.5 cm}
%% \begin{center}
%% \begin{minipage}{0.95\linewidth}
%% \centering \large \textcolor{violet}{\bf This problem is due to a historical fact; it's not an essential one. Industry-standard formats like Avro and Parquet can store complex physics events; we just happen to have a lot of data in ROOT files.}
%% \end{minipage}
%% \end{center}
%% \vspace{0.1 cm}
%% \end{minipage}}
...
%% \centering \only<2->{\textcolor{darkgreen}{JsRoot}} & \only<2->{\textcolor{darkgreen}{Javascript}} & \only<1>{\mbox{\hspace{4 cm}} \mbox{\hspace{4 cm}}}\only<2->{\textcolor{darkgreen}{For interacting with ROOT in the browser or standalone.}} & \only<2->{\textcolor{darkgreen}{Sergey Linev}} \\
...
%% \vspace{1 cm}
%% \uncover<2->{\Large They have fancy d3 visualizations, but lack convenient workaday routines for quick histograms, profiles, heatmaps, lego plots, etc.}
