...
\item<3-> Usually fitting a known theory or parameterized model.
...
\item<2-> Transactions accumulate in the database while analyzing.

\item<3-> Modeling human behavior, more interested in predictions than parameters of a model.
...
\begin{frame}{Can we bridge the divide?}
\vspace{0.17 cm}
