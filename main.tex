...
\vspace{0.5 cm}
\begin{center}
\uncover<3>{\textcolor{darkorange}{\large My goal within DIANA-HEP is to make it easier for physicists to use Big Data tools in their analyses, particularly for interactive, exploratory analysis.}}
\end{center}
\end{frame}
