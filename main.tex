...
%% \vspace{0.5 cm}
%% \begin{center}
%% \uncover<3>{\textcolor{darkorange}{\bf My goal within DIANA-HEP is to make it easier for physicists to use Big Data tools in their analyses, particularly for interactive, exploratory analysis.}}
%% \end{center}
%% \end{frame}
...
\vspace{-5.2 cm}
\begin{center}
\fcolorbox{violet}{white}{\begin{minipage}{0.85\linewidth}
\vspace{0.5 cm}
\begin{center}
\begin{minipage}{0.9\linewidth}
\centering \large \textcolor{violet}{These issues are historical. Industry-standard formats like Avro and Parquet can store complex physics events; we just happen to have a lot of data in ROOT files.}
\end{minipage}
\end{center}
\vspace{0.1 cm}
\end{minipage}}
